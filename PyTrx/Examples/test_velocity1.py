...
camdata = '../Examples/camenv_data/camenvs/CameraEnvironmentData_test_velocity1.txt'
camvmask = '../Examples/camenv_data/masks/test_velocity1_vmask.jpg'
caminvmask = '../Examples/camenv_data/invmasks/test_velocity1_inv.jpg'
camimgs = '../Examples/images/test_velocity1_subset/*.JPG'
...
target1 = '../Examples/camenv_data/calib/test_velocity1_1.txt'
...
#    os.makedirs(target3, exist_ok=True)                #Create file destination
...
if not os.path.exists(target5):
    os.makedirs(target5, exist_ok=True)
